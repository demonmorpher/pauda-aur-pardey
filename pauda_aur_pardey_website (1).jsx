export default function PaudaAurPardeyWebsite() {
  const plants = [
    {
      title: "Indoor Greens",
      image:
    ...
    <div className="min-h-screen bg-neutral-50 text-neutral-900">
      <header className="sticky top-0 z-20 border-b border-neutral-200 bg-white/90 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          <div>
            <h1 className="text-2xl font-bold tracking-tight">Pauda aur Pardey</h1>
            <p className="text-sm text-neutral-600">Plants, curtains, and beautiful home styling</p>
          </div>
        ...
        <div className="grid gap-10 md:grid-cols-2 md:items-center">
          <div>
            ...
            <p className="mt-4 leading-8 text-neutral-600">
              Pauda aur Pardey is a concept for people who love homes that feel soft, natural, and welcoming. By combining plant styling with elegant curtain ideas, this brand celebrates comfort, beauty, and everyday living.
            </p>
          </div>
